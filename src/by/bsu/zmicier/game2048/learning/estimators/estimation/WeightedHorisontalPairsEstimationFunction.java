 ...
 */
public class WeightedHorisontalPairsEstimationFunction extends AbstractAnalyticsEstimationFunction {
    public WeightedHorisontalPairsEstimationFunction(PositionAnalyticsWrapperFactory factory) {
        super(factory);
    }

    @Override
    public float estimatePosition(Position<Integer> p) {
        return factory.getWrapper(p).getWeightedHorisontalPairs();
    }
}

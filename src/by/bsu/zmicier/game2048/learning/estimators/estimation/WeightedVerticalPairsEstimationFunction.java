 ...
 */
public class WeightedVerticalPairsEstimationFunction extends AbstractAnalyticsEstimationFunction {
    public WeightedVerticalPairsEstimationFunction(PositionAnalyticsWrapperFactory factory) {
        super(factory);
    }

    @Override
    public float estimatePosition(Position<Integer> p) {
        return factory.getWrapper(p).getWeightedVerticalPairs();
    }
}

 ...
 */
public class CornerMaxTileEstimationFunction extends AbstractCornerAnalyserEstimationFunction {
    public CornerMaxTileEstimationFunction(PositionAnalyticsWrapperFactory factory) {
        super(factory);
    }

 ...
 */
public class DefaultAvailableTilesMaster extends Game2048AvailableTilesMaster<Integer> {
    public DefaultAvailableTilesMaster(Game2048RulesMediator<Integer> server) {
        super(server);
    }
